			...
			<div class="panel-body" style="padding-top: 30px;">
				...
				<form id="loginform" class="form-horizontal" role="form">
					<div class="input-group" style="margin-bottom: 25px;">
						...
						<input type="text" name="username" id="login-username" class="form-control" value="" placeholder="username">
					</div>
					<div class="input-group" style="margin-bottom: 25px;">
					...
					<div class="input-group">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="remember" value="1" id="login-remember">
							</label>
						</div>
					</div>
		...
		<div class="panel panel-info">
			<div class="panel-heading">
				...
				<div style="float: right; font-size: 85%; position: relative; top: -10px;">
					<a href="#" id="signinlink" onclick="$('#signupbox').hide(); $('#loginbox').show()">Sign In
					</a>
				</div>
			</div>
			<div class="panel-body">
				<form id="signupform" class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="phone" class="col-md-3 control-label">Nomer Telp/WA</label>
						<div class="col-md-9">
